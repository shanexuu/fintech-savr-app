...
const AddExpense = () => {
  ...
  // State variables
  const [selectedIcon, setSelectedIcon] = useState('💸') // Default icon for expenses
  const [selectedColor, setSelectedColor] = useState(Colors.purple.light) // Default color for expenses
  ...
  const onCreateExpense = async () => {
    ...
    const { data, error } = await supabase
      ...
      .insert([
        {
          name: categoryTitle, // Use selected category title
          icon: selectedIcon,
          amount: amount,
